...
(function ($) {
    ...
    function _1f(_20) {
        ...
        _25.comboTarget = _20;
        if (_25.closed) {
            _23.panel("panel").show().css({
                zIndex: ($.fn.menu ? $.fn.menu.defaults.zIndex++ : ($.fn.window ? $.fn.window.defaults.zIndex++ : 99)),
                left: -999999
            });
            _23.panel("resize", {
                width: (_24.panelWidth ? _24.panelWidth : _22._outerWidth()),
                height: _24.panelHeight
            });
    ...
    $.fn.combo = function (_4c, _4d) {
        ...
        return this.each(function () {
            ...
            if (_4f) {
                ...
                _4f = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _4c),
                    previousText: ""
                });
    ...
    $.fn.combo.methods = {
        options: function (jq) {
            ...
            return jq.each(function () {
                ...
                $.data(this, "combo", {
                    options: $.extend(true, {cloned: true}, $(_51).combo("options")),
                    combo: $(this).next(),
    ...
    $.fn.combo.parseOptions = function (_57) {
        var t = $(_57);
        return $.extend({}, $.fn.textbox.parseOptions(_57), $.parser.parseOptions(_57, ["separator", "panelAlign", {
            panelWidth: "number",
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _16, keydown: _1b, paste: _1b, drop: _1b},
        panelEvents: {
